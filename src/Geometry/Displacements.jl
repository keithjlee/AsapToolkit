...
"""
function ElementDisplacements(element::Asap.FrameElement, model::Model; resolution = 20)
...
"""
function ElementDisplacements(element::Asap.TrussElement, model::Model; resolution = 20)
...
"""
    ElementDisplacements(elements::Vector{<:Asap.AbstractElement}, model::Model; resolution = 20)

Get the displacements of an ordered chain of elements that form a single physical member.
"""
function ElementDisplacements(elements::Vector{<:Asap.AbstractElement}, model::Model; resolution = 20)
